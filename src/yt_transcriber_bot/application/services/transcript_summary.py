...
from yt_transcriber_bot.application.ports.text_generation import (
    TextGenerationClient as ChatCompletionClient,
)
from yt_transcriber_bot.application.ports.text_generation import (
...
class SummaryResult:
    """Pure application result before derived-artifact persistence."""
...
class TranscriptSummaryService:
    ...
    def __init__(
        ...
        *,
        ...
        self._tokenizer = tokenizer or _EstimatedTokenizer(chars_per_token=self._chars_per_token)
    ...
    def summarize(
        ...
        *,
        ...
        content = _wrap_summary_markdown(
            snap,
        ...
        return SummaryResult(
            content=content, chunks=effective_chunks, model=self._chat_client.model
        )
