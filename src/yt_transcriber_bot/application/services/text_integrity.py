"""Application-owned artifact text normalization and integrity policy."""
...
def normalize_artifact_text(text: str) -> str:
    """Normalize text used by canonical/derived transcript artifacts."""
...
def unresolved_text_corruption_score(text: str) -> int:
    """Count strong residual corruption markers after normalization."""
